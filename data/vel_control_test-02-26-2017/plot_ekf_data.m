...
split_filename = regexp(data_filename,'\_ekf.','split');
...
input_time = in_raw.data(:,1);
input_val = in_raw.data(:,2);
input_time = input_time(input_val ~= 0);

t_in_0 = (input_time(1)-t0)*1e-9
t_in_f = (input_time(end)-t0)*1e-9
...
%save([file_prefix{1} '_vel.mat'],'t_step','vx_step','vy_step','vz_step')
